...
export default function LoginForm() {
  ...
  const { setHasAccount, isForgotPassword, setIsForgotPassword } = useContext(HasAccountContext);
        ...
        <Box>
          ...
          <form noValidate onSubmit={onSubmit}>
            ...
            >
              ...
              <Typography>
                <Link onClick={() => setIsForgotPassword(true)} sx={{ textDecoration: "none", cursor: "pointer" }}>
                  Forgot Password?
                </Link>
              </Typography>
            </Grid>
